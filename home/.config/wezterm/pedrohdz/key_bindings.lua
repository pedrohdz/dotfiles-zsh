...
function _M.apply(config)
  ...
  config.keys = {
    ...
    { key = 'LeftArrow',  mods = 'SHIFT|CMD', action = action.MoveTabRelative(-1), },
    { key = 'RightArrow', mods = 'CMD|OPT',   action = action.ActivateTabRelativeNoWrap(1), },
    { key = 'RightArrow', mods = 'SHIFT|CMD', action = action.MoveTabRelative(1), },
...
-- ----------------------------------------------------------------------------
-- NOTE - Original (stock) key bindings:
--
--  ```
...
--     { key = 'LeftArrow', mods = 'ALT|SUPER', action = act.ActivateTabRelativeNoWrap(-1) },
--     { key = 'RightArrow', mods = 'SHIFT|CTRL', action = act.ActivatePaneDirection 'Right' },
--     { key = 'RightArrow', mods = 'SHIFT|ALT|CTRL', action = act.AdjustPaneSize{ 'Right', 1 } },
--     { key = 'RightArrow', mods = 'SHIFT|SUPER', action = act.MoveTabRelative(1) },
--     { key = 'RightArrow', mods = 'ALT|SUPER', action = act.ActivateTabRelativeNoWrap(1) },
