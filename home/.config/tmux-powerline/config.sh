...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="pedrohdz"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/zx/g_2lfy0x7wn88scskcg4pjt80000gr/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/pedher/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/pedher/.mailcheckrc"
# }
