...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR='53'
...
TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
  "#[fg=$TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR,bg=colour55,nobold,noitalics,nounderscore]" \
...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info gray90 black" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117" \
		# "date_day 235 136" \
		"date gray2 white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time gray2 white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"utc_time 235 136 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"hostname gray90 black ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
	)
fi
